## INITIAL COMMENTS ##
#get influenza for Germany from Google Trends
...
path = 'd:\python2'
os.chdir(path)
filename = 'GoogleTrendDataMeasles_DE.csv'
...
kw_list = ['Masern']
start_date = datetime(2013, 10, 20).date()
...
pytrend.build_payload(kw_list=kw_list, timeframe = timeframe, geo='DE')
